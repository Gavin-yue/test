# Generated by Django 2.1.8 on 2019-11-30 10:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manager.Manager', verbose_name='商家名称')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manager.Type', verbose_name='类别')),
            ],
            options={
